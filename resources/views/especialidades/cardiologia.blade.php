...
<div class="row">
            <div class="col-12">
                <h2 class="text-center">CENTRO CARDIOLOGÍCO SAN BERNARDINO - CARDIOLOGÍA EN GENERAL</h2>
            </div>
        </div>
        <div class="p-2"></div>
    <div class="row">
        <div class="col-3">
            <div class="row">
                <div class="col-12"><img class="img-fluid" src="{{asset('img/cardiologia/jesse-orrico-Us3AQvyOP-o-unsplash.jpg')}}" alt=""></div>
            </div>
            <div class="p-2"></div>
            <div class="row">
                <div class="col-12"><img class="img-fluid" src="{{asset('img/cardiologia/robina-weermeijer-sAHiIKGKjjA-unsplash.jpg')}}" alt=""></div>
            </div>
        </div>
        <div class="col-3">
            <div class="row">
                <div class="col-12"><img class="img-fluid" src="{{asset('img/cardiologia/robina-weermeijer-Tmkwl7EjVtE-unsplash.jpg')}}" alt=""></div>
            </div>
            <div class="p-2"></div>
            <div class="row">
                <div class="col-12"><img class="img-fluid" src="{{asset('img/cardiologia/robina-weermeijer-z8_-Fmfz06c-unsplash.jpg')}}" alt=""></div>
            </div>
        </div>
        <div class="col-6 align-self-center">
            <p class="text-justify h5">
                ...
                Cuando uno se enfrenta a una enfermedad compleja como una enfermedad del corazón, es importante encontrar al especialista más indicado.
            </p>
        </div>
    </div>
    <div class="p-2"></div>
