...
<div class="row">
            <div class="col-12">
                <h2 class="text-center">QUIMIOTERAPIA SAN BERNARDINO - QUIMIOTERAPIA EN GENERAL</h2>
            </div>
        </div>
        <div class="p-2"></div>
        <div class="p-2"></div>
    <div class="row">
        <div class="col-3">
            <div class="row">
                <div class="col-12"><img class="img-fluid" src="{{asset('img/servicios_medicos/resonancia.jpg')}}" alt=""></div>
            </div>
            <div class="p-2"></div>
            <div class="row">
                <div class="col-12"><img class="img-fluid" src="{{asset('img/servicios_medicos/img1.jpg')}}" alt=""></div>
            </div>
        </div>
        <div class="col-3">
            <div class="row">
...
@section("footer")
CENTRO QUIMIOTERAPIA DE SAN BERNARDINO - SERVICIO MEDICO ESPECIALISTA EN QUIMIOTERAPIA - EMERGENCIAS QUIMIOTERAPIA - MEDICOS QUIMIOTERAPIA CON AMPLIA TRAYECTORIA - CONTAMOS CON HOSPILAIZACION PARA PACIENTES CON AFECIONES QUIMIOTERAPIA - CLINICA QUIMIOTERAPIA EN SAN BERNARDINO - EXAMENES QUIMIOTERAPIA 24 HORAS - CITAS DE QUIMIOTERAPIA - CONSULTORIOS PARA CITAS DE QUIMIOTERAPIA - SALA DE EMERGENCIA EN QUIMIOTERAPIA  - CENTRO MEDICO EN QUIMIOTERAPIA - MEDICOS QUIMIOTERAPIA QUIRURGICOS EN SAN BERNARDINO - ESPECIALISTAS EN QUIMIOTERAPIA -  UNIDAD DE QUIMIOTERAPIA EN CARACAS - CLINICA CUIDADOS POSOPERATORIA EN CARACAS VENEZUELA - MEDICOS QUIMIOTERAPIA EN CARACAS VENEZUELA - CLINICA PODOLOGICA Y ORTOPEDICAS EN CARACAS - QUIMIOTERAPIA EN CARACAS- MEDICOS  QUIMIOTERAPIA EN CARACAS VENEZUELA - EMERGENCIA MEDICA PODOLOGICA - QUIMIOTERAPIA EN SAN BENADINO CARACAS VENEZUALA - CENTRO PODOLOGICO - COP.
@endsection